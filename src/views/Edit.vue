<template>
    <div class="editViews" v-if="model">
        ...
        <div class="uploadfile">
            <div class="uploadfile"><van-uploader preview-size='100vw' :after-read='afterRead'/></div>
            <edit-banner left="头像"> 
                <img :src="model.user_img" alt="" slot="right" v-if="model.user_img">
                <img src="@/assets/default_img.jpg" alt="" slot="right" v-else>
            </edit-banner>
        </div>
            <edit-banner left='名称' @bannerClick="show=true">
            ...
            <edit-banner left='个性标签' @bannerClick='textshow=true'></edit-banner>
